...
function editCardContent(card, newFilmlocation, index) {
    ...
    // document.getElementById("push-comment").setAttribute('onclick', `submitcomment(${index})`)

    // console.log("current card index:", index);
    
    // const cardComment = card.querySelector("textarea");
    // cardComment.setAttribute("id", `textarea-${index}`)
}
...
//     const cardComment = document.getElementById(`textarea-${index}`); 
//     console.log(`textarea-${index}`);
//     console.log(cardComment.value);

//     filmlocations[index].comment.push(cardComment.value);
//     const cardInput = document.getElementById("comment-input");
//     cardInput.textContent = filmlocations[index].comment[0];
// }